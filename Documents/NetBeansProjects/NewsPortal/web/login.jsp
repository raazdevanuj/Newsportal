    ...
    <body class="bg-secondary">
       <%
		...
		<div class="card">
			...
			<div class="card-body">
                            <form action="login.jsp?op=login" method="post">
						...
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-key"></i></span>
                                        ...
                                        <div class="form-group ">
                                            <input type="checkbox" name="remember" value="yes"><span class="text-white"> Remember Me</span>
   ...
   <% 
    if(request.getParameter("submit")!=null) {
        ...
        if(role.equals("reporterLogin")){
            ...
            Reporter reporter = rd.isValid(userid, password);
            if (reporter!=null)
            {
