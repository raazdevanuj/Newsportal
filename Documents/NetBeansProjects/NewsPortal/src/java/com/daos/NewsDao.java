...
public class NewsDao {
   ...
   public ArrayList<News>  getAllApprovedNews(){
       ...
       if(con!=null){
        try{
            ...
            System.out.println("Errorass :"+e.getMessage());
        }
       }
       
    return newss;
   }
   public ArrayList<News> getAllpend(int id){
       ...
       if(con!=null){
        try{
            String sql = "select * from news where status='pending' and id=? order by id";
            PreparedStatement smt = con.prepareStatement(sql);
            smt.setInt(1,id);
          ...
          //  System.out.println("33333333333333333");
            ...
            System.out.println("Errorssa :"+e.getMessage());
    ...
    public ArrayList<News> getAllproved(int id){
       ...
       if(con!=null){
        try{
            String sql = "select * from news where status='approved' and  reporter_id=?";
            PreparedStatement smt = con.prepareStatement(sql);
            smt.setInt(1,id);
          //  System.out.println("1111111111111");
            ResultSet rs= smt.executeQuery();
   ...
   public ArrayList<News> getAllrejected(int id){
       ...
       if(con!=null){
        try{
            String sql = "select * from news where status='rejected' and reporter_id=? order by id";
            PreparedStatement smt = con.prepareStatement(sql);
            smt.setInt(1,id);
          //  System.out.println("1111111111111");
            ResultSet rs= smt.executeQuery();
    ...
    public ArrayList<News> getAllpendNews(){
       ...
       if(con!=null){
        try{
            String sql = "select * from news where status='pending' order by id desc";
            PreparedStatement smt = con.prepareStatement(sql);
          //  System.out.println("1111111111111");
            ResultSet rs= smt.executeQuery();
            while(rs.next()){
   ...
   public boolean  update(News news,String[] catids){
    ...
    public boolean  updat1(News news,String[] catids){
       boolean status=false;
       ConnectionPool cp = ConnectionPool.getInstance();
       cp.initialize();
       Connection con = cp.getConnection();
       if(con!=null){
        try{
            con.setAutoCommit(false);
            String sql = "update news set title=?, description=?, status='pending', status_text='pending for approval by admin' where id=?";
            PreparedStatement smt = con.prepareStatement(sql);
            smt.setString(1, news.getTitle());
            smt.setString(2, news.getDescription());
   ...
   public ArrayList<News>  getNewsByCategory(int catid){
    ...
    public ArrayList<News>  getNewsfilter(int rid,int catid){
       ...
       if(con!=null){
        try{
            String sql = "select * from news where reporter_id=(?) and id in(select news_id from ncr where cat_id =?)";
            PreparedStatement smt = con.prepareStatement(sql);
             smt.setInt(1, rid);
             smt.setInt(2,catid);
   ...
   public int getNewsReporter(int reporterid){
    int k=0;
       ConnectionPool cp = ConnectionPool.getInstance();
       cp.initialize();
       Connection con = cp.getConnection();
