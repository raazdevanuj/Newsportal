        ...
        <div id="wrapper">
            ...
            <jsp:include page="sidebar.jsp"></jsp:include>
                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <jsp:useBean class="com.beans.scp" id="sc" scope="session"></jsp:useBean>
                            ...
                            <center>
                                <div class="container" >
                                    <div class="row">
                                        ...
                                        <jsp:setProperty name="sc" property="*"></jsp:setProperty>
                                            <form action="../ProductController?op=Add" method="post" enctype="multipart/form-data">
                                                <div class="card align-center">     
                                                    <div class="card-header bg-primary text-white"><i class="fa fa-registered"></i> add Photo Here</div>
                                                    <center> <img src="" style="width:150px; height: 150px;" id="preview" class="form-control"/> <br/>
                                                        <input  type="file" name="photo" onchange="readURL(this, preview);" required class="form-control btn btn-success"/></center> <br/>
                                                ...
                                                <table class="table">
                                                    <tr><td>Select Category Name</td>
                                                        <td ><select name="category_id" id="cid" onclick="selectsub(this.value, sid)">
                                                                ...
                                                                <%
                                                                    ...
                                                                    for (Category sd : cat) {
                                                                %>
                                                                <option value="<%=sd.getCategory_id()%>" <%if (sd.getCategory_id() == sc.getCategory_id()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><select name="sub_category_id" id="sid">
                                                                ...
                                                                ArrayList<Sub_category> sub=sv.getAllRecordsId(sc.getCategory_id());
                                                                for(Sub_category p:sub){
                                                                %>
                                                                <option value="<%=p.getSub_category_id()%>" <%if (p.getSub_category_id() == sc.getSub_category_id()) {
                                                                        out.println(" selected");
                                                    ...
                                                    <tr><td>Enter Product Name </td>
                                                        <td><input type="text" name="product_name"  Required="Required" class="form-control" value="${product.product_name}" /></td>
                                                    </tr> 
                                                    <tr><td>Enter Product Brand </td>
                                                        <td><input type="text" name="product_Brand"  Required="Required" class="form-control" value="${product.product_Brand}" /></td>
                                                    </tr>
                                                    <tr><td>Enter Product Price </td>
                                                        <td><input type="text" name="product_price"   autocomplete="off" Required="Required" class="form-control" value="${product.product_price}" /></td>
                                                    </tr>
                                                    <tr><td>Enter Product Description </td>
                                                        <td><input type="text" name="product_desc"  Required="Required" class="form-control" value="${product.product_desc}" /></td>
                                                    </tr>
                                                </table>
