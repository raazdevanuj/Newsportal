                    ...
                    <form method="post" class="form">
                        ...
                        <div class="card">
                            ...
                            <table class="table">
                                ...
                                <td><input type="text" name="category_name"  Required="Required" class="form-control" /></td>
                                </tr> 

                            </table>
                            <center> <input type="submit" value="save" name="submit" id ="submit" class="form-control btn btn-primary col col-md-2"/></center>
                    </form>
                </div>
...
<%
    ...
    <%
        ...
        if(cd.add(category))
        out.println("<script>alert('Category Added successfully');</script>");
        else
