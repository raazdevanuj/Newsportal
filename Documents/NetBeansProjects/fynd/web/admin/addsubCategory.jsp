            ...
            <jsp:include page="sidebar.jsp"></jsp:include>
                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <jsp:include page="topbar.jsp"></jsp:include>
                        <!-- End of Topbar -->
<jsp:useBean class="com.beans.Sub_category" id="sub_category" scope="session"></jsp:useBean>
                        <!-- Begin Page Content -->
                            ...
                            <center>
                                <div class="container" >
                                    <div class="row">
                                        ...
                                        <jsp:setProperty name="sub_category" property="*"></jsp:setProperty>
                                        <form action="../SubController?op=add" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <tr><td>Select Category Name</td>
                                                        <td ><select name="category_id" class="form-group">
                                                                ...
                                                                <%
                                                                    ...
                                                                    for (Category sd : cat) {
                                                                %>
                                                                <option value="<%=sd.getCategory_id()%>" <%if (sd.getCategory_id()==sub_category.getCategory_id()) {out.println(" selected");}%>><%=sd.getCategory_name()%></option>
                                                                <%}%>
                                                            </select></td></tr>
                                                    <td>Enter Sub_category Name </td>
                                                    <td><input type="text" name="sub_category_name"  Required="Required" class="form-control" value="${sub_category.sub_category_name}" /></td>
                                                    </tr> 
